  ...
  <div class="bg-sky-800 h-50 justify-between w-96 rounded-r-full shadow-md fixed top-0 z-10">
    <div class="flex space-x-4 p-2">
      <ul class="flex space-x-4">
        ...
        <li><a href="#guarderia" class="text-sky-50 text-transform: uppercase font-bold hover:text-sky-200">Servicios</a></li>
        <li><a href="#" class="text-sky-50 text-transform: uppercase font-bold hover:text-sky-200">Nosotros</a></li>
        <li><a href="#" class="text-sky-50 text-transform: uppercase font-bold hover:text-sky-200">Contacto</a></li>
      </ul>
    </div>
  </div>
`;
...
logo.className = 'logo bg-white fixed right-1 h-28 w-28 flex items-center z-20 rounded-b-full border-sky-800 border-b-2 border-l-2 border-r-2 py-1';
